...
class MaskedRange extends _pattern_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  */
  doPrepare(ch) {
    let flags = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    let details;
    [ch, details] = Object(_core_utils_js__WEBPACK_IMPORTED_MODULE_1__["normalizePrepare"])(super.doPrepare(ch.replace(/\D/g, ''), flags));
...
/* harmony import */ var _modules_init_smoth_scroll__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/init-smoth-scroll */ "./js/modules/init-smoth-scroll.js");
/* harmony import */ var _modules_validate_input_phone__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/validate-input-phone */ "./js/modules/validate-input-phone.js");
/* harmony import */ var _modules_opened_mobile_menu__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/opened-mobile-menu */ "./js/modules/opened-mobile-menu.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    Object(_modules_validate_input_phone__WEBPACK_IMPORTED_MODULE_2__["validateInputPhone"])();
    Object(_modules_opened_mobile_menu__WEBPACK_IMPORTED_MODULE_3__["openedMobileMenu"])();
    Object(_modules_init_smoth_scroll__WEBPACK_IMPORTED_MODULE_1__["initSmothScroll"])();
  });
});
...
/*!******************************************!*\
  !*** ./js/modules/creates-mask-phone.js ***!
  \******************************************/
/*! exports provided: createsMaskPhone */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createsMaskPhone", function() { return createsMaskPhone; });
/* harmony import */ var imask__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! imask */ "../node_modules/imask/esm/index.js");

var iMask = imask__WEBPACK_IMPORTED_MODULE_0__["default"];
var createsMaskPhone = function createsMaskPhone(phone) {
  iMask(phone, {
...
/*!*****************************************!*\
  !*** ./js/modules/init-smoth-scroll.js ***!
  \*****************************************/
/*! exports provided: initSmothScroll */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initSmothScroll", function() { return initSmothScroll; });
/* harmony import */ var _makes_smoth_scroll__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./makes-smoth-scroll */ "./js/modules/makes-smoth-scroll.js");

var linkList = document.querySelectorAll('[data-smoth-scroll-link]');
var initSmothScroll = function initSmothScroll() {
  linkList.forEach(function (link) {
    Object(_makes_smoth_scroll__WEBPACK_IMPORTED_MODULE_0__["makesSmothScroll"])(link);
  });
};
...
/*!******************************************!*\
  !*** ./js/modules/makes-smoth-scroll.js ***!
  \******************************************/
/*! exports provided: makesSmothScroll */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "makesSmothScroll", function() { return makesSmothScroll; });
...
/*!******************************************!*\
  !*** ./js/modules/opened-mobile-menu.js ***!
  \******************************************/
/*! exports provided: openedMobileMenu */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "openedMobileMenu", function() { return openedMobileMenu; });
...
/* harmony import */ var _makes_smoth_scroll__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./makes-smoth-scroll */ "./js/modules/makes-smoth-scroll.js");
...
var header = document.querySelector('.header__top-wrapper');
var linkList = document.querySelectorAll('[data-mobile-scroll-link]');
nav.classList.remove('nav--nojs');
var focusLock = new _utils_focus_lock__WEBPACK_IMPORTED_MODULE_0__["FocusLock"]();
var scrollLock = new _utils_scroll_lock__WEBPACK_IMPORTED_MODULE_1__["ScrollLock"]();
...
var openedMobileMenu = function openedMobileMenu() {
  ...
  linkList.forEach(function (link) {
    link.addEventListener('click', function () {
      var activeLink = link;
      closeMenu();
      Object(_makes_smoth_scroll__WEBPACK_IMPORTED_MODULE_2__["makesSmothScroll"])(activeLink);
    });
  });
};
...
/*!********************************************!*\
  !*** ./js/modules/validate-input-phone.js ***!
  \********************************************/
/*! exports provided: validateInputPhone */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "validateInputPhone", function() { return validateInputPhone; });
/* harmony import */ var _creates_mask_phone__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./creates-mask-phone */ "./js/modules/creates-mask-phone.js");

var feedbackPhone = document.querySelector('#feedback-tel');
var validateInputPhone = function validateInputPhone() {
  Object(_creates_mask_phone__WEBPACK_IMPORTED_MODULE_0__["createsMaskPhone"])(feedbackPhone);
  var validateInputValue = function validateInputValue(input) {
    input.addEventListener('input', function () {
      var phoneValue = input.value.length;
      if (phoneValue < 16) {
